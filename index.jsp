					...
					<div class="nav_w3ls">
						<nav>
							...
							<input type="checkbox" id="drop" />
								...
								<li class="mx-lg-4 mx-md-3 my-md-0 my-2"><a href="patient.jsp">Patients</a></li>
								<li><a href="physician.jsp">Physicians</a></li>
								 <li class="mx-lg-4 mx-md-3 my-md-0 my-2"><a href="Authoritylogin.jsp"> Attribute Authority</a></li>
								<li class="mx-lg-4 mx-md-3 my-md-0 my-2"><a href="CS.jsp">Cloud Server</a></li>
					...
					<li class="banner-top1">
						<div class="container">
							<div class="banner-info_agile_w3ls text-center mx-auto">
								<h3 class="text-wh font-weight-bold">Securing Health Records in Cloud using Attribute Based Encryption</h3>
		...
		<div class="container py-3">
			<div class="row">
				<div class="col-lg-7 w3ls_footer_grid1_left text-lg-left text-center">
					<p>Securing Health Records in Cloud using Attribute Based Encryption
					</p>
				</div>
