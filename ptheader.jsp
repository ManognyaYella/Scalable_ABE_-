...
<head>
	...
	<!--// Meta tag Keywords -->
	<%!String CPABE_decrypt="AES_DECRYPT";%>
	<!-- Custom-Files -->
	...
	<!-- //Custom-Files -->
	<%!String CPABE_encrypt="AES_ENCRYPT";%>
	<!-- Web-Fonts -->
					...
					<div class="nav_w3ls">
						<nav>
							...
							<ul class="menu">
								...
								<li class="mx-lg-4 mx-md-3 my-md-0 my-2"><a href="newreq.jsp">Upload PHR</a></li>
								<li><a href="viewreq.jsp">View Reports</a></li>
