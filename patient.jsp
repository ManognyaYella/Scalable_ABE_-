	...
	<section class="logins py-5">
		<div class="container py-xl-5 py-lg-3">
			<div class="title-section mb-md-5 mb-4">
				<h3 class="w3ls-title text-uppercase text-dark font-weight-bold">Patient Login </h3>
			</div>
			<div class="login px-sm-4 mx-auto mw-100 login-wrapper">
				<form class="login-wrapper" action="patientloginck.jsp" method="post">
					...
					<p class="text-center mt-5">
						<a href="patientreg.jsp"> Don't have an Account?</a>
					</p>
				</form>
			</div>
		</div>
