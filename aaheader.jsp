					...
					<div class="nav_w3ls">
						<nav>
							...
							<ul class="menu">
								...
								<li class="mx-lg-4 mx-md-3 my-md-0 my-2">><a href="sysint.jsp">Setup</a></li>
								<li class="mx-lg-4 mx-md-3 my-md-0 my-2">><a href="patients.jsp">Patients</a></li>
								<li class="mx-lg-4 mx-md-3 my-md-0 my-2">><a href="doctors.jsp">Physicians</a></li>
