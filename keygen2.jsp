...
int i =st1.executeUpdate("update physician set sk='"+SK.toString()+"' where uid='"+request.getParameter("unm")+"' ");

if(i>0){
st.executeUpdate("update physician set sts='Active' where uid='"+request.getParameter("unm")+"' ");
